...
class Provider extends React.Component {
  ...
  componentDidMount() {
    ...
    socket.on('USER_CREATED', data => {this.setState({status: 'USER_CREATED', userCreated: true}); this.logStatusData('USER_CREATED', data)});
    ...
    socket.on('GOT_ROOM_STATE', data => {
      ...
      this.logStatusData('GOT_ROOM_STATE', data)
    });
    socket.on('GOT_ROOM_LIST', data => this.logStatusData('GOT_ROOM_LIST', data));
    socket.on('GOT_FULL_STATE', data => this.logStatusData('GOT_FULL_STATE', data));
    socket.on('CLEAR_STATE', data => this.logStatusData('CLEAR_STATE', data));
  };
      ...
      return (
          <Context.Provider
              value={{
                  ...
                  isInGame: !!this.state.roomData.kingOrder.length,
                  isInRoom: !!this.state.roomData.roomName,
                  ...
                  isRoomOwner: this.state.userName === this.state.roomData.roomOwner,
